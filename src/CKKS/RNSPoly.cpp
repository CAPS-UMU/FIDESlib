...
void RNSPoly::evalLinearWSumMultiple(int max_n, const std::vector<const RNSPoly*>& in, const std::vector<RNSPoly*>& out, const std::vector<uint64_t>& elem, const bool isC1) {
...
void RNSPoly::dotProductPt(RNSPoly& c1_, const std::vector<const RNSPoly*>& c0s_, const std::vector<const RNSPoly*>& c1s_, const std::vector<const RNSPoly*>& pts_, const bool ext, int slots) {
