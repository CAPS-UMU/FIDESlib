...
__global__ void mult1Add2_(const __grid_constant__
    ...
    template <typename T>
 __global__ void addMult_(T* l, const T* l1, const T* l2, const __grid_constant__int primeid,
                          const __grid_constant__int elem_l2);

__global__ void addMult_(void** l, void** l1, void** l2, const __grid_constant__int primeid_init,
                         const __grid_constant__int elem_l2);

__global__ void Mult_(void** l, void** l1, void** l2, const __grid_constant__int primeid_init,
                      const __grid_constant__int elem_l2);

__global__ void square_(void** l, void** l1, const __grid_constant__int primeid_init);

__global__ void binomial_square_fold_(void** c0_res, void** c2_key_switched_0, void** c1, void** c2_key_switched_1,
                                      const __grid_constant__int primeid_init);
    template <ALGO algo>
 __global__ void Scalar_mult_(void** a, const uint64_t* b, const __grid_constant__int primeid,
                              const uint64_t* shoup_mu);

__global__ void broadcastLimb0_(void** a);
__global__ void broadcastLimb0_mgpu_(void** a, const __grid_constant__int primeid_init, void** limb0);
...
__global__ void dotProductPt_(void** c0,
                              ...
                              const int n,
                              const __grid_constant__int elem_data);
...
__global__ void
    dotProductLtBatchedPt___(void*** c0_out,
                             ...
                             const int primeidInit,
                             const int n,
                             const __grid_constant__int elem_pts);
__global__ void
...
__global__ void addScaleB_(void** a, void** b, void** c, const int primeid_init, const __grid_constant__int elem_c);
__global__ void addScaleC_(void** a, void** b, void** c, const int primeid_init, const __grid_constant__int elem_c);
...
__global__ void
    binomialDotProdBatched___(const __grid_constant__
