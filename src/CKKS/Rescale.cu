...
namespace FIDESlib::CKKS
{
 ...
 __global__ void SwitchModulus(const T* src, const int __grid_constant__ o_primeid, T* res,
    ...
    template __global__ void SwitchModulus<uint32_t>(const uint32_t* src, const int __grid_constant__ o_primeid,
                                                     uint32_t* res, const int __grid_constant__ n_primeid);

    template __global__ void SwitchModulus<uint64_t>(const uint64_t* src, const int __grid_constant__ o_primeid,
