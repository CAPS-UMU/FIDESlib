...
*/
    ...
    static void
    evalLinearWSumMultiple(int max_n, const std::vector<const LimbPartition*>& in, const std::vector<LimbPartition*>& out, const std::vector<unsigned long int>& elem, bool isC1);
