...
__device__ __forceinline__ void backward_negacyclic_scale_1D(char* buffer, const int primeid, T* psi, T* psi_shoup, const Global::Globals* Globals, const int logn) {
...
template <typename T, ALGO algo, INTT_MODE mode>
__device__ __forceinline__ void INTT_1D__(const Global::Globals* Globals,
